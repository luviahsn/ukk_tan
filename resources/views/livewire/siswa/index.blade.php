    ...
    <div class="p-6 bg-white rounded-2xl shadow-md mx-3 my-6 font-poppins">
            ...
            <div class="flex justify-end items-center mb-4 gap-4">
                ...
                <div x-data="{ open: false }" class="relative inline-block text-left">
                    ...
                    <div x-show="open" @click.away="open = false" x-transition
                        ...
                        <!-- FILTER ROMBEL -->
                        <div>
                            <h3 class="text-pink-600 font-semibold text-sm mb-2">Filter Rombel</h3>
                            <div class="flex gap-3 flex-wrap">
                                @foreach($rombels as $value => $label)
                                    <label class="flex items-center gap-1 text-gray-700 text-sm">
                                        <input type="checkbox" wire:model.live="selected_rombel" value="{{ $value }}"
                                            class="text-pink-500 focus:ring-pink-500 border-gray-300 rounded" />
                                        {{ $label }}
                                    </label>
                                @endforeach
        ...
        @endif
            ...
            <table class="w-full text-sm text-left rtl:text-right text-gray-700">
                ...
                <tbody>
                    @php $no = $siswas->firstItem(); @endphp
                    ...
                    @forelse ($siswas as $key => $siswa)
                        <tr class="bg-white border-b hover:bg-pink-50">
                            ...
                            <td class="px-6 py-4">
                                ...
                                src="{{asset('storage/' . $siswa->foto)}}" alt="foto siswa" />
                            </td>
...
<td class="px-6 py-4">
    {{ $siswa->gender 
        ...
        : 'Gender tidak tersedia' }}
                    ...
                    @empty
                        <tr>
                            <td colspan="8" class="text-center py-4 text-gray-500">Siswa Tidak Terdaftar</td>
                        </tr>
                    @endforelse
                </tbody>
            </table>
